...
def main():
    ...
    parser.add_argument("--train_paths_file", type=str, default="CASIAv2/files.txt",
    ...
    parser.add_argument("--valid_paths_file", type=str, default="CASIAv2/files.txt",
    ...
    parser.add_argument('--load_path', type=str, default=None,
                        help='pretrained model or checkpoint for continued training')
    ...
    train_dataloader = DataLoader(dataset=train_dataset, batch_size=args.batch_size, num_workers=args.workers,
                                  shuffle=True,
                                  pin_memory=True, drop_last=True)
    valid_dataloader = DataLoader(dataset=valid_dataset, batch_size=args.batch_size, num_workers=args.workers,
                                  shuffle=False,
                                  pin_memory=True, drop_last=True)
